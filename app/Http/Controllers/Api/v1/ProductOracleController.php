...
class ProductOracleController extends Controller
{
     private $product;

    public function __construct(Oracle $product) 
    {
    ...
    public function store(Request $request)
    {
        ...
        if($validate->fails()){
            ...
            return $erro =  response()->json(['validate.error', $messages]);
           //  return $erro =  response()->json(['validate.error', $messages],422);
